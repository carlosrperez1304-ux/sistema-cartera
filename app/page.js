        ...
        <div className={`sidebar${showMobileMenu ? ' mobile-open' : ''}`}>
          ...
          <div className="sidebar-user-footer">
            ...
            <div className="sidebar-user-actions">
              ...
              <button className="sidebar-icon-btn" onClick={() => { window._manualLogout = true; signOut({ callbackUrl: '/' }); }} title="Cerrar sesión">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="settings-overlay" onClick={e => { if (e.target === e.currentTarget) setShowSettingsPanel(false); }}>
          <div className="settings-panel">
            ...
            <div className="settings-sidebar">
              ...
              <button className="settings-nav-item" style={{ marginTop: 'auto', color: 'var(--danger)', opacity: 0.8 }} onClick={() => { window._manualLogout = true; setShowSettingsPanel(false); signOut({ callbackUrl: '/' }); }}>
